<section class="elementor-section elementor-top-section elementor-element elementor-element-2fee197d elementor-section-full_width elementor-section-height-default elementor-section-height-default">
    <img src="{{ asset('storage/'.$value->cover_photo) }}" />
        ...
        <div class="rhea-ultra-main-slider-detail">
            <div class="ultra-slider-property-detail">
                <h3 class="rhea-ultra-main-slider-title">
                    <a href="#">{{ $value->name }}</a>
                    <span class="rhea-ultra-slider-year-build">Build 2019</span>
                </h3>

                <div class="rvr_card_info_wrap">
                    <p class="added-date">
                        <span class="added-title">Added:</span> June 8, 2022
                    </p>
                </div>
            </div>
                ...
                <div class="rhea_ultra_prop_card__meta" style=" order: 1 ">
                    ...
                    <div class="rhea_ultra_meta_icon_wrapper">
                        ...
                        <span class="rhea_ultra_meta_box">
                            <span class="figure">{{ $value->bhk_type }}</span>
                        </span>
                    </div>
                </div>
            ...
            <div class="rhea-ultra-slider-price">
                <span class="rhea-ultra-slider-property-status">For Sale </span>
