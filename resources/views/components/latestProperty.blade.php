    ...
    <div class="rhea-ultra-property-card">
        <div class="rhea-ultra-card-thumb-wrapper">
            <div class="rhea-ultra-property-thumb">
                <a class="rhea_permalink" href="">
                    <img decoding="async"  width="488" height="326" src="{{ asset('storage/'.$value->cover_photo )}}" class="attachment-property-thumb-image size-property-thumb-image wp-post-image" />
                </a>            
            </div>
                
            <div class="rhea-ultra-top-tags-box">
                <div class="rhea-ultra-status-box">
                    <a href="#" class="rhea-ultra-status">{{ $value->buy_sell }}</a>                    
                </div>

                <div class="rhea-ultra-media-count-box">
                    <div class="rhea_ultra_media_count">
                        <div class="rhea_media rhea_media_image" data-fancybox-trigger="gallery-4943001a-101" data-this-id="101">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
                                <path class="st0" d="M3 5h12c1.1 0 2 0.9 2 2v8c0 1.1-0.9 2-2 2H3c-1.1 0-2-0.9-2-2V7C1 5.9 1.9 5 3 5zM7.7 1h2.8c0.8-0.2 1.7 0.4 1.8 1.2 0 0 0 0.1 0 0.1L13 5H5l0.7-2.7C5.9 1.4 6.8 0.8 7.7 1zM9 7.4c2.2 0 4 1.8 4 4s-1.8 4-4 4 -4-1.8-4-4S6.8 7.4 9 7.4zM9 9c1.3 0 2.4 1.1 2.4 2.4s-1.1 2.4-2.4 2.4 -2.4-1.1-2.4-2.4S7.7 9 9 9L9 9zM8.2 2.6h1.6c0.4 0 0.8 0.4 0.7 0.9 0 0.4-0.3 0.7-0.7 0.7H8.2c-0.4 0-0.8-0.3-0.9-0.7 0-0.4 0.3-0.8 0.7-0.9C8.1 2.6 8.2 2.6 8.2 2.6z"></path>
                            </svg>            
                            <span>4</span>
                        </div>
                        <div class="rhea_media rhea_media_video" data-fancybox-trigger="video-4943001a-101" data-this-id="101">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
            ...
            <div class="rhea-ultra-bottom-box rhea-ultra-flex-end">
                <div class="rhea-ultra-action-buttons rh-ultra-action-light hover-light">
                    ...
                    <span class="add-to-compare-span rhea_compare_icons rhea_svg_fav_icons compare-btn-101" data-property-id="101" data-property-title="Villa in Coral Gables" data-property-url="https://ultra.realhomes.io/property/villa-in-coral-gables/" data-property-image="https://ultra-realhomes.b-cdn.net/wp-content/uploads/2020/06/property-2-488x326.jpg">
                        ...
                        <a class="rh_trigger_compare rhea_add_to_compare rh-ui-tooltip" title="Add To Compare" href="https://ultra.realhomes.io/property/villa-in-coral-gables/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path class="rh-ultra-light" d="M11.1 23l-3.4-3.4v-1.2l3.4-3.4h1l2 4 9 0h-9l-2 4H11.1zM12 9l-2-4L1 5h9l2-4 1 0 3.4 3.4v1.2L12.9 9H12z"></path>
                                <path class="rh-ultra-dark" d="M12.5 2l2.8 2.8v0.3L12.5 8l-1.4-2.9L11.1 5l0.1-0.1L12.5 2M11.5 16l1.4 2.9 0.1 0.1 -0.1 0.1L11.5 22l-2.8-2.8v-0.3L11.5 16M13.3 0h-2v0l-2 4H0v2h9.3l2 4h2l4-4V4L13.3 0 13.3 0zM12.7 14h-2l-4 4v2l4 4h2v0l2-4H24v-2h-9.3L12.7 14 12.7 14z"></path>
                            </svg>			
        ...
        <div class="rhea-ultra-card-detail-wrapper">
            <h3 class="rhea-ultra-property-title"><a href="">{{ $value->name }}</a></h3>
            <div class="rhea_address_ultra">
                <a class="rhea_trigger_map rhea_facnybox_trigger-4943001a " data-rhea-map-source="rhea-map-source-4943001a" data-rhea-map-location="25.637835760899,-80.300602037109,14" data-rhea-map-title="Villa in Coral Gables" data-rhea-map-price=" $825,000 " data-rhea-map-thumb="https://ultra-realhomes.b-cdn.net/wp-content/uploads/2020/06/property-2-488x326.jpg" href="https://ultra.realhomes.io/property/villa-in-coral-gables/">
                    <span class="rhea_ultra_address_pin">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="5 2 14 20">
                            <style type="text/css">  
                                .line-st0{fill:none;}
                                .line-st1{opacity:0.24;enable-background:new    ;}
                            </style>
                            <path class="line-st0" d="M0 0h24v24H0V0z"></path>
                            <path class="line-st1" d="M12 4C9.2 4 7 6.2 7 9c0 2.9 2.9 7.2 5 9.9 2.1-2.7 5-7 5-9.9C17 6.2 14.8 4 12 4zM12 11.5c-1.4 0-2.5-1.1-2.5-2.5s1.1-2.5 2.5-2.5 2.5 1.1 2.5 2.5S13.4 11.5 12 11.5z"></path><path d="M12 2C8.1 2 5 5.1 5 9c0 5.3 7 13 7 13s7-7.8 7-13C19 5.1 15.9 2 12 2zM7 9c0-2.8 2.2-5 5-5s5 2.2 5 5c0 2.9-2.9 7.2-5 9.9C9.9 16.2 7 11.9 7 9z"></path><circle cx="12" cy="9" r="2.5"></circle></svg>
                    </span>
                {{ $value->address }}
                </a>
            </div>
            ...
            <div class="rhea-ultra-price-meta-box">
                <div class="rh_prop_card__priceLabel_ultra">
                    <p class="rh_prop_card__price_ultra">
                        <span class="ere-price-display">{{ $value->price }}.00</span>
                    </p>
                </div> 
            ...
            <div class="rvr_card_info_wrap">
                <p class="added-date"><span class="added-title">Added:</span> June 14, 2022</p>
            </div>
        </div>
    </div>
</div>
